...
class TravelPlan(TypedDict):
    ...
    destination: Optional[str] = None   # "Paris"
    dates: Optional[Dict[str, str]] = None  # {"start": "2025-06-01", "end": "2025-06-05"}

    # === Expensive stuff from tools ===
    search_results: Optional[List[str]] = None  # raw chunks from flight/hotel API

    # === Generated by the agent ===
    itinerary: Optional[List[str]] = None       # ["Day 1: Eiffel Tower...", "Day 2: ..."]
    draft_review: Optional[List[str]] = None    # LLM or human feedback before sending